...
export default function FileCard({
    ...
    const cardContent = (
        <motion.div
            className={cn(
                "relative w-full h-full aspect-3/4 rounded-lg border bg-transparent backdrop-blur-xs overflow-hidden cursor-pointer hover:scale-[101%] hover:shadow-md transition-all duration-300",
                className,
            )}
